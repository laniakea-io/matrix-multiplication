...
# ╔═╡ cfa05fd6-ed06-11f0-9cec-a3d542b3f81a
begin
	using Plots
	using CSV
	using DataFrames
...
# ╔═╡ 27382beb-722a-41b5-9847-3577fdcc6df5
t = CSV.read("./csv/time.csv", DataFrame)

# ╔═╡ 3a4022cc-5dfd-46d7-ae00-c016ce508220
plot(t.step, [t.strassen, t.standard, t.julia],
	 	label=["Strassen" "Estandar" "Julia: A*B"], 
	 	marker=:circle, linestyle=:dash, 
	 	grid=true, gridlinewidth=2
	)

# ╔═╡ 7f706cce-aa58-4dc7-9f63-4c641d870993
# 5 primeras mediciones
ta = first(t, 5)

# ╔═╡ 0f404d07-91bc-48bc-9e53-d90b612bbefa
plot(ta.step, [ta.strassen, ta.standard, ta.julia],
	 	label=["Strassen" "Estandar" "Julia: A*B"], 
	 	marker=:circle, linestyle=:dash, 
	 	grid=true, gridlinewidth=2
	)
...
manifest_format = "2.0"
project_hash = "0d719eea4b5944ddcd4e17baec61a354b8abf155"
